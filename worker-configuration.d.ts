/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 12ff4276e89b0f299962b83b726ec91d)
// Runtime types generated with workerd@1.20250428.0 2025-04-04 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		VALUE_FROM_CLOUDFLARE: "Hello from Cloudflare";
		COLOR_SCHEME_SECRET: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "COLOR_SCHEME_SECRET">> {}
}
